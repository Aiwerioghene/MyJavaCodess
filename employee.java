...
public class employee {
    ...
    static public class Employee{
        ...
        public Employee(String fname, String lname, double salary)
        {
            ...
            if (salary>0) {
                ...
                System.out.println("The salary is not a positive value");
            }
        }
    ...
    public static void main(String[] args)
    {
        ...
        Employee employee_1 = new Employee("Adesuwa", "Evans", 20000);
        Employee employee_2 = new Employee("Jaden", "Smith", 1000);
